...
public class CalendarHelper {
  ...
  public static Calendar convertDateTimeToDate(DateTime dateTime) {
   ...
   */
  public static Calendar getDateFromString(String dateString, String dateFormat)
      throws ParseException {
  ...
  public static ArrayList<String> convertToStringList(Set<DateTime> dateTimes) {
